...
export const metadata: Metadata = {
  title: "DTLP Privacy Policy",
  description: "Datatech Learning Placeのプライバシーポリシーページです。",
  openGraph: {
    title: "DTLP Privacy Policy",
    description: "Datatech Learning Placeのプライバシーポリシーページです。",
    url: "https://datatech-learning-place.net/global/privacy",
...
export default function PrivacyPage() {
  return (
    <div>
      <p className="mb-6">本ページはDatatech Learning Placeのプライバシーポリシーです。</p>
