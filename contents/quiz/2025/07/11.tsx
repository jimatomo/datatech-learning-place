...
export default function QuizContent() {
  const quiz = new Quiz({
    ...
    tags: ["Snowflake", "FILE", "AI_COMPLETE", "非構造化データ"],
    ...
    references: [
      { title: "Snowflake Documentation - Unstructured data types", url: "https://docs.snowflake.com/en/sql-reference/data-types-unstructured" },
      { title: "Snowflake Documentation - AI_COMPLETE (Single file)", url: "https://docs.snowflake.com/en/sql-reference/functions/ai_complete-single-file" },
    ],
  });
