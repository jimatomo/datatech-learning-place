    ...
    <div className="text-xs md:text-sm">
      ...
      <ul className="list-disc pl-4">
        <li className="pb-2">
          ...
          ：これは間違った記述です。実際は<span className="text-red-500">宣言型IaCの方が設定ドリフトの管理が容易</span>です。宣言型IaCでは望ましい状態を定義するため、ツールが現在の状態と比較して差分を自動的に検出・修正できます。命令型IaCでは、実行した手順の結果として現在の状態がどうなっているかを追跡するのが困難で、設定ドリフトが発生しやすくなります。
        </li>
      </ul>
