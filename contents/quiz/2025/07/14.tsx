...
export default function QuizContent() {
  const quiz = new Quiz({
    ...
    tags: ["Snowflake", "データロード", "STRIP_OUTER_ARRAY", "JSON"],
    ...
    options: {
      ...
      1: "STRIP_OUTER_ARRAYをTRUEに設定すると、JSONファイルの最外層の配列が削除される",
  ...
  return (
    <div className="text-xs md:text-sm">
      ...
      <ul className="list-disc pl-4 space-y-2">
        ...
        <li>
          <strong className="text-emerald-500">STRIP_OUTER_ARRAYをTRUEに設定すると、JSONファイルの最外層の配列が削除される</strong>：
