...
export default function QuizContent() {
  const quiz = new Quiz({
    ...
    references: [
      ...
      { title: "Real Python PEP8 Guide", url: "https://realpython.com/python-pep8/" },
  ...
  return (
    <div>
      <p className="pb-4">
        ...
        <strong className="text-green-500">正しいもの</strong>を
        <strong className="text-blue-500">すべて</strong>選択してください。
      </p>
