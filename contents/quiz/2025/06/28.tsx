  ...
  return (
    <div className="text-xs md:text-sm">
      ...
      <ul className="list-disc pl-4 py-2">
        <li>
          <strong>選択肢0（正しい）：</strong>
          意味的モデルは、ビジネスドメインの概念とその関係性を明確に定義することで、
          データの意味を構造化し、組織内でのデータ理解を統一します。
          これにより、データサイエンティスト、ビジネスアナリスト、開発者間での
          共通言語が確立されます。
        </li>
        <li className="py-2">
          <strong>選択肢1（正しい）：</strong>
          統制語彙は、同一概念を表す複数の表記（「顧客」「お客様」「Customer」など）を
          標準化された用語に統一する仕組みです。これにより、データの品質向上、
          検索精度の改善、システム間の相互運用性が実現されます。
        </li>
        <li>
          <strong>選択肢2（正しい）：</strong>
          オントロジーは概念間の複雑な関係性を表現し、タクソノミーは階層構造を定義します。
          これらは意味的モデルの基盤となり、RDF、OWL、SKOSなどの標準技術で実装されます。
        </li>
        <li className="py-2">
          <strong>選択肢3（間違い）：</strong>
          統制語彙は継続的な維持管理が必要です。ビジネス環境の変化、新しい概念の追加、
          廃止された用語の管理、同義語の追加など、定期的な更新とガバナンスプロセスが
          不可欠です。放置すると語彙の一貫性が失われ、データ品質が劣化します。
        </li>
        <li>
          <strong>選択肢4（間違い）：</strong>
          意味的モデルは技術とビジネスの橋渡し役です。ビジネス用語、業務プロセス、
