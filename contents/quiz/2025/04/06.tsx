...
export default function QuizContent() {
  const quiz = new Quiz({
    ...
    tags: ["Data Integration", "Datatech News", "DuckDB", "dbt"],
...
function QuizExplanation() {
  return (
    <div className="text-xs md:text-sm">
      ...
      <p className="pt-4">
        DuckDB自体はまだまだ開発が活発な状態で、まだまだ認知は少ないですが、
        近年ものすごい勢いで注目を集めているインメモリの分析エンジンです。
        今後もキャッチアップを続けてコスト最適化を目指して利用できるユースケースを探していきましょう。
      </p>
    </div>
  );
} 
