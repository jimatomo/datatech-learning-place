...
export default function QuizContent() {
  const quiz = new Quiz({
    ...
    // ----- quiz -----
    title: "マスタデータマネジメント（MDM）のプロセス",
    question_jsx: <QuizQuestion />,
    options: {
      0: "データモデリング: 管理対象となるマスタデータの構造、属性、リレーションシップを定義する。",
      1: "データ収集と統合: 複数のデータソースからマスタデータを収集し、重複を排除して統合されたレコード（ゴールデンレコード）を生成する。",
...
function QuizQuestion() {
  return (
    <div>
      <p className="pb-4">
        マスタデータマネジメント（MDM）の主要なプロセスに関する記述のうち、
...
function QuizExplanation() {
  return (
    <div className="text-xs md:text-sm">
      ...
      <div className="mb-4">
        <p className="font-semibold text-emerald-500">「データモデリング: 管理対象となるマスタデータの構造、属性、リレーションシップを定義する。」✅ 適切：</p>
        <p className="text-sm leading-relaxed">
      ...
      <div className="mb-4">
        <p className="font-semibold text-emerald-500">「データ収集と統合: 複数のデータソースからマスタデータを収集し、重複を排除して統合されたレコード（ゴールデンレコード）を生成する。」✅ 適切：</p>
        <p className="text-sm leading-relaxed">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mt-4">
        ...
        <ul className="list-disc pl-6 space-y-1 text-sm text-blue-700">
          <li><strong>目的:</strong> 信頼できるマスタデータを維持・管理し、組織全体で利用できるようにすること。</li>
